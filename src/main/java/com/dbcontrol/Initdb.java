...
//        initProjectDB();
    ...
    public static void initInvestorDB() {
        ...
        List<Investor> Investors = asList(
                Investor.builder().investorId("0").orgNm("平台").pthoneNm("18723565421").investor("平台投资人").introd("投资专家").invesPhotoRoute("E:\\investor\\1\\杨博.jpg").price(new BigDecimal("0")).disCountPrice(new BigDecimal("0")).build(),
                Investor.builder().investorId("1").orgNm("高瓴资本").pthoneNm("19991967502").investor("杨博").introd("团队长").invesPhotoRoute("E:\\investor\\1\\杨博.jpg").price(new BigDecimal("500")).disCountPrice(new BigDecimal("98")).build(),
                ...
                Investor.builder().investorId("9").orgNm("易帆国际").pthoneNm("15325896525").investor("张三").introd("资深数据分析。").invesEmail("zhiyunhuang@cmbchina.com").invesPhotoRoute("E:\\investor\\9\\张三.jpg").price(new BigDecimal("500")).disCountPrice(new BigDecimal("98")).build()
        );
