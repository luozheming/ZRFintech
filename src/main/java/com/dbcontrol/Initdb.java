...
//        initProjectDB();
    ...
    public static void initInvestorDB() {
        ...
        List<Investor> Investors = asList(
                Investor.builder().investorId(new CommonUtils().getNumCode()).orgNm("企融星").phoneNm("12345678901").investor("平台投资人").introd("投资专家").invesPhotoRoute("E:\\investor\\0\\平台.jpg").invesOrgPhotoRoute("E:\\investor\\0\\平台.jpg").price(new BigDecimal("0")).disCountPrice(new BigDecimal("0")).isPlatform(true).build(),
                Investor.builder().investorId(new CommonUtils().getNumCode()).orgNm("高瓴资本").phoneNm("12345678901").investor("杨某").introd("团队长").invesPhotoRoute("E:\\investor\\1\\杨博.jpg").invesOrgPhotoRoute("E:\\investor\\1\\杨博.jpg").price(new BigDecimal("500")).disCountPrice(new BigDecimal("98")).isPlatform(false).build(),
                ...
                Investor.builder().investorId(new CommonUtils().getNumCode()).orgNm("易帆国际").phoneNm("12345678901").investor("张三").introd("资深数据分析。").invesEmail("zhiyunhuang@cmbchina.com").invesPhotoRoute("E:\\investor\\9\\张三.jpg").invesOrgPhotoRoute("E:\\investor\\9\\张三.jpg").price(new BigDecimal("500")).disCountPrice(new BigDecimal("98")).isPlatform(false).build()
        );
