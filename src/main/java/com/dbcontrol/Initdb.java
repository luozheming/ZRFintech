...
//        initProjectDB();
    ...
    public static void initInvestorDB() {
        ...
        List<Investor> Investors = asList(
                Investor.builder().investorId("0").orgNm("平台").phoneNm("18723565421").investor("平台投资人").introd("投资专家").invesPhotoRoute("E:\\investor\\1\\杨博.jpg").price(new BigDecimal("0")).disCountPrice(new BigDecimal("0")).build(),
